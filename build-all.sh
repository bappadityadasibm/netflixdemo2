...
then
cd microservices/composite/product-composite-service; ./gradlew clean build -PreleaseType=minor; ./gradlew javadoc -PreleaseType=minor; cd -
...
cd microservices/composite/product-composite-service; ./gradlew clean build -PreleaseType=major; ./gradlew javadoc -PreleaseType=major; cd -
fi
